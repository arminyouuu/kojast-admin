/*
  ...
  2. Security
    ...
    - Public read access for enabled categories, places, and place_images
  ...
  3. Indexes
    ...
    - Index on categories.is_enabled for filtering
  ...
  4. Important Notes
    ...
    - Categories can be enabled/disabled without deletion
*/

-- Create categories table with is_enabled field
...
-- Public read access policies for enabled categories only
